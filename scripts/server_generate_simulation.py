...
def generate_runners(yaml_path=None, large_size=False):
    ...
    for benchmark in BENCHMARKS:
        ...
        with open(file_path, "w") as f:
            ...
            if benchmark == "gups":
                f.write(f"cp {CachePWQ_PATH}/simulator/mgpusim/samples/gups/starts.bin ./\n")
            ...
            if large_size:
                ...
                if benchmark == "kmeans":  # 1024 MB
                    cmd.append(
                        "-points=2097152 -features=16 -clusters=20 -max-iter=1 "
                    )
