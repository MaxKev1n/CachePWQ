...
def plot_normalized_time(
    ...
    opt_4K["Data"] = [
        (
            baseline_4K["Data"][i] / opt_4K["Data"][i]
    ...
    opt_64K["Data"] = [
        (
            baseline_64K["Data"][i] / opt_64K["Data"][i]
    ...
    opt_2M["Data"] = [
        (
            baseline_2M["Data"][i] / opt_2M["Data"][i]
...
if __name__ == "__main__":
    ...
    for benchmark in get_high_mpki_benchmarks():
        ...
        baseline_4K = append_row(baseline_4K, benchmark, "../../final_final_data/baseline")
        ...
        opt_4K     = append_row(opt_4K,     benchmark, "../../final_final_data/nbwalker-full")
