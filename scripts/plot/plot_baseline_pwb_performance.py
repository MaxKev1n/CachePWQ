...
def plot_normalized_time(
    ...
    output_file = os.path.join(
        out_dir, "Baseline_PWB_Performance"
    )
...
if __name__ == "__main__":
    ...
    for benchmark in get_high_mpki_benchmarks():
        ...
        Opt1     = append_row(Opt1,     benchmark, "../../final_final_data/baseline_512walkers_4ports")
        Opt2     = append_row(Opt2,     benchmark, "../../final_final_data/baseline_512walkers_8ports")
        Opt3     = append_row(Opt3,     benchmark, "../../final_final_data/baseline_512walkers_16ports")
        Opt4     = append_row(Opt4,     benchmark, "../../final_final_data/baseline_512walkers_512ports")
