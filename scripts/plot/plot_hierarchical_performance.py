...
def plot_normalized_time(
    ...
    plt.ylabel("Normalized Time", fontsize=24, fontweight="bold")
    plt.yticks(
        np.arange(0, 2.1, 0.5),
        fontsize=26,
        fontweight="bold",
    ...
    output_file = os.path.join(
        out_dir, "HierarchicalGPU_Normalized_Time"
    )
...
if __name__ == "__main__":
    ...
    for benchmark in get_benchmarks():
        perf_data = collect_performance_data(
            ...
            input_dir="../../data/HierarchicalMemorySide-1cycle-l3tlb",
        )
        ...
        perf_data = collect_performance_data(
            benchmark_name=benchmark,
            input_dir="../../data/HierarchicalMemorySide-50cycle-l3tlb",
        )
        ...
        perf_data = collect_performance_data(
            benchmark_name=benchmark,
            input_dir="../../data/HierarchicalMemorySide-100cycle-l3tlb",
        )
        ...
        perf_data = collect_performance_data(
            benchmark_name=benchmark,
            input_dir="../../data/HierarchicalMemorySide-200cycle-l3tlb",
        )
