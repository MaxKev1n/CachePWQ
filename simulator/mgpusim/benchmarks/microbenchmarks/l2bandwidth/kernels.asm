	...
	.protected	l2_slice_bandwidth ; -- Begin function l2_slice_bandwidth
	.globl	l2_slice_bandwidth
	.p2align	8
	.type	l2_slice_bandwidth,@function
	.amdgpu_hsa_kernel l2_slice_bandwidth
l2_slice_bandwidth:                     ; @l2_slice_bandwidth
l2_slice_bandwidth$local:
	.amd_kernel_code_t
...
; %bb.0:
	...
	s_endpgm
.Lfunc_end0:
	.size	l2_slice_bandwidth, .Lfunc_end0-l2_slice_bandwidth
                                        ; -- End function
...
Version:         [ 1, 0 ]
Kernels:
  - Name:            l2_slice_bandwidth
    SymbolName:      'l2_slice_bandwidth@kd'
    Language:        OpenCL C
    LanguageVersion: [ 1, 2 ]
    Args:
      - Name:            src
