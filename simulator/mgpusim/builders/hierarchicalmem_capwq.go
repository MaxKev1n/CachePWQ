...
func (b *HierarchicalMemSideCaPWQGPUBuilder) BuildSAs(chiplet *Chiplet) {
...
func (b *HierarchicalMemSideCaPWQGPUBuilder) establishMMUToL1RoutingPath(chiplet *Chiplet) {
	lowModuleFinder := cache.NewXORLowModuleFinder(
		len(chiplet.L1VCaches),
		4,
...
func (b *HierarchicalMemSideCaPWQGPUBuilder) buildMemBanks(chiplet *Chiplet) {
...
func (b *HierarchicalMemSideCaPWQGPUBuilder) connectL2TLBTOMMU(chiplet *Chiplet) {
