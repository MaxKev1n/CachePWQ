...
// HierarchicalMemSideDistTLBPlatformBuilder can build a platform that equips DisTLBGPU GPU.
type HierarchicalMemSideDistTLBPlatformBuilder struct {
	CommonPlatformBuilder
}

// MakeHierarchicalMemSideDistTLBPlatformBuilder creates a EmuBuilder with default parameters.
func MakeHierarchicalMemSideDistTLBPlatformBuilder() HierarchicalMemSideDistTLBPlatformBuilder {
	b := HierarchicalMemSideDistTLBPlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b HierarchicalMemSideDistTLBPlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *HierarchicalMemSideDistTLBPlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeHierarchicalMemSideDistTLBGPUBuilder()
