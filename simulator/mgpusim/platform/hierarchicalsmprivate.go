...
// HierarchicalSMSidePrivateTLBPlatformBuilder can build a platform that equips DisTLBGPU GPU.
type HierarchicalSMSidePrivateTLBPlatformBuilder struct {
	CommonPlatformBuilder
}

// MakeHierarchicalSMSidePlatformBuilder creates a EmuBuilder with default parameters.
func MakeHierarchicalSMSidePrivateTLBPlatformBuilder() HierarchicalSMSidePrivateTLBPlatformBuilder {
	b := HierarchicalSMSidePrivateTLBPlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b HierarchicalSMSidePrivateTLBPlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *HierarchicalSMSidePrivateTLBPlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeHierarchicalSMSidePrivateTLBGPUBuilder()
