...
type SMSidePlatformBuilder struct {
	CommonPlatformBuilder
}

// Makebuilder creates a EmuBuilder with default parameters.
func MakeSMSideBuilder() SMSidePlatformBuilder {
	b := SMSidePlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b SMSidePlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *SMSidePlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeSMSideGPUBuilder()
