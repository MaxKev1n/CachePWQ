...
// FullSMSidePlatformBuilder can build a platform that equips DisTLBGPU GPU.
type FullSMSidePlatformBuilder struct {
	CommonPlatformBuilder
}

// MakeFullSMSideBuilder creates a EmuBuilder with default parameters.
func MakeFullSMSideBuilder() FullSMSidePlatformBuilder {
	b := FullSMSidePlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b FullSMSidePlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *FullSMSidePlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeFullSMSideGPUBuilder()
