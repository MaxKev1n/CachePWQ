...
func (b HierarchicalMemSidePlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *HierarchicalMemSidePlatformBuilder) createGPUBuilder(
	engine akita.Engine,
	gpuDriver *driver.Driver,
) builders.Builder {
	gpuBuilder := builders.MakeHierarchicalMemSideGPUBuilder()
